...
namespace BAL.Repositories
{
    public class orderRepository : BaseRepository
    {
        ...
        public orderRepository()
            : base()
        {
            DBContext = new db_a861ba_madinaEntities();

        }

        public orderRepository(db_a861ba_madinaEntities contextDB)
            : base(contextDB)
        {
            DBContext = contextDB;
        }
            ...
            try
            {
                ...
                foreach (var i in _dsOrders)
                {
                    ...
                    if (_OCustomer != null)
                    {
                        ...
                        ocustomer.LastUpdatedDate = _OCustomer.LastUpdatedDate;
                        ocustomer.DeliveryArea=  _OCustomer.DeliveryArea;
                    ...
                    try
                    {
                        ...
                        if (tempCustomerOrders != null)
                        {
                            ...
                            orders.CustomerOrders.Add(new CustomerOrder
                            {
                                ...
                                DeliveryArea=tempCustomerOrders.DeliveryArea
                            });
                        }
                        ...
                        try
                        {
                            ...
                            foreach (var item in getTokens)
                            {
                                ...
                                token.Title = obj.BrandName == "" ? "Madina Restaurant" : obj.BrandName + " | New Order for Delivery";
