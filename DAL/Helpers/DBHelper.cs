...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=sql8003.site4now.net;initial catalog=db_a861ba_madina;persist security info=True;user id=db_a861ba_madina_admin;password=Tech@123;";
